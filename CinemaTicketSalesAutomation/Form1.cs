using SinemaTicketSalesAutomation.Helpers;
...
namespace SinemaTicketSalesAutomation
{
    public partial class Form1 : Form
    {
        ...
        private void button_Click(object sender, EventArgs e)//<-- Bir seansa tıklandığı zaman
        {
